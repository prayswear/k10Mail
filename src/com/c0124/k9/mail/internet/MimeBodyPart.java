...
public class MimeBodyPart extends BodyPart {
    ...
    (
    	author = "Jing Teng", 
    	description = "Set Content-Transfer-Encoding 7bit for multipart/encrypted instead of 8 bit,"
    			+ "k9 will then encode its parts to 7 bit and set Content-Transfer-Encoding of each parts to base64"
    )    
    public void setBody(Body body) throws MessagingException {
        ...
        if (body instanceof Multipart) {
            ...
            if (MimeUtility.isCryptoType(type)) {
    ...
    public void setDisposition(String disposition) throws MessagingException {
    	setHeader(MimeHeader.HEADER_CONTENT_DISPOSITION, disposition);
    }
    ...
    public void setUsing7bitTransport() throws MessagingException {
        ...
        if (mBody instanceof CompositeBody
            ...
            return;
                ...
                && ((MimeUtility.isCryptoType(type)) || type
