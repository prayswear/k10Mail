...
import com.c0124.k9.mail.internet.BinaryTempFileBody.BinaryTempFileBodyInputStream;
...
public class MimeUtility {
    ...
    public static String getEncodingforType(String type) {
        ...
        } else if (isCryptoType(type) || type.toLowerCase(Locale.US).startsWith("message/")) {
    ...
    public static boolean isCryptoType(final String type) {
		return type.toLowerCase().startsWith("multipart/signed") || type.toLowerCase().startsWith("multipart/encrypted");
	}
    
    public static boolean isMultipart(Message message) throws MessagingException {
    	return message.getMimeType().startsWith("multipart");
    }
}
