...
import com.c0124.k9.activity.UpgradeDatabases;
...
import com.c0124.k9.mail.internet.BinaryTempFileBody;
import com.c0124.k9.mail.store.LocalStore;
import com.c0124.k9.provider.UnreadWidgetProvider;
import com.c0124.k9.security.LocalKeyStore;
import com.c0124.k9.service.BootReceiver;
import com.c0124.k9.service.MailService;
import com.c0124.k9.service.ShutdownReceiver;
import com.c0124.k9.service.StorageGoneReceiver;
...
public class K9 extends Application {
     ...
     * was called.
     * Afterwards calls to {@link #registerApplicationAware(com.c0124.k9.K9.ApplicationAware)} will
     * immediately call {@link com.c0124.k9.K9.ApplicationAware#initializeComponent(K9)} for the
     * supplied argument.
     */
    ...
    final public static String DECRYPTION_FOLDER_NAME = "_decrypted";
    final public static String ENCRYPTION_FOLDER_NAME = "_encrypt";
    ...
    public static int MAX_ENCRYPT_ATTEMPTS = 10;
    ...
    public static class Intents {
        ...
        public static class EmailReceived {
            public static final String ACTION_EMAIL_RECEIVED    = "com.c0124.k9.intent.action.EMAIL_RECEIVED";
            public static final String ACTION_EMAIL_DELETED     = "com.c0124.k9.intent.action.EMAIL_DELETED";
            public static final String ACTION_REFRESH_OBSERVER  = "com.c0124.k9.intent.action.REFRESH_OBSERVER";
            public static final String EXTRA_ACCOUNT            = "com.c0124.k9.intent.extra.ACCOUNT";
            public static final String EXTRA_FOLDER             = "com.c0124.k9.intent.extra.FOLDER";
            public static final String EXTRA_SENT_DATE          = "com.c0124.k9.intent.extra.SENT_DATE";
            public static final String EXTRA_FROM               = "com.c0124.k9.intent.extra.FROM";
            public static final String EXTRA_TO                 = "com.c0124.k9.intent.extra.TO";
            public static final String EXTRA_CC                 = "com.c0124.k9.intent.extra.CC";
            public static final String EXTRA_BCC                = "com.c0124.k9.intent.extra.BCC";
            public static final String EXTRA_SUBJECT            = "com.c0124.k9.intent.extra.SUBJECT";
            public static final String EXTRA_FROM_SELF          = "com.c0124.k9.intent.extra.FROM_SELF";
        }

        public static class Share {
            /*
             * We don't want to use EmailReceived.EXTRA_FROM ("com.c0124.k9.intent.extra.FROM")
             * because of different semantics (String array vs. string with comma separated
             * email addresses)
             */
            public static final String EXTRA_FROM               = "com.c0124.k9.intent.extra.SENDER";
        }
    }
    ...
    public void onCreate() {
        ...
        {
            ClientHelper.i(LOG_TAG, "application creating");
            if (com.c0124.utility.DebugPolicy.getInstance().toSendCrashReport()) {
                ACRA.init(this);
            }
        }
        registerActivityLifecycleCallbacks(new LifecycleHandler());

        TipsManager.LoadTips(app);
