...
public class ChooseFolder extends K9ListActivity {
    public static final String EXTRA_ACCOUNT = "com.c0124.k9.ChooseFolder_account";
    public static final String EXTRA_CUR_FOLDER = "com.c0124.k9.ChooseFolder_curfolder";
    public static final String EXTRA_SEL_FOLDER = "com.c0124.k9.ChooseFolder_selfolder";
    public static final String EXTRA_NEW_FOLDER = "com.c0124.k9.ChooseFolder_newfolder";
    public static final String EXTRA_MESSAGE = "com.c0124.k9.ChooseFolder_message";
    public static final String EXTRA_SHOW_CURRENT = "com.c0124.k9.ChooseFolder_showcurrent";
    public static final String EXTRA_SHOW_FOLDER_NONE = "com.c0124.k9.ChooseFolder_showOptionNone";
    public static final String EXTRA_SHOW_DISPLAYABLE_ONLY = "com.c0124.k9.ChooseFolder_showDisplayableOnly";
        ...
        public void listFolders(Account account, Folder[] folders) {
            ...
            for (Folder folder : folders) {
                ...
                try {
                    ...
                    if ( (mAccount.getEncryptionFolderName().equalsIgnoreCase(name) ||
                        mAccount.getDecryptionFolderName().equalsIgnoreCase(name)) && 
                        !com.c0124.utility.DebugPolicy.getInstance().toShowEncryptAndDecryptFolder() ) {
                        continue;
                    }

                    //aMode is required mode, fMode is folder's mode
