...
import com.c0124.k9.activity.misc.NonConfigurationInstance;
...
import com.c0124.k9.mail.ServerSettings;
...
import com.c0124.k9.preferences.SettingsExporter;
import com.c0124.k9.preferences.SettingsImportExportException;
import com.c0124.k9.preferences.SettingsImporter;
import com.c0124.k9.preferences.SettingsImporter.AccountDescription;
import com.c0124.k9.preferences.SettingsImporter.AccountDescriptionPair;
import com.c0124.k9.preferences.SettingsImporter.ImportContents;
import com.c0124.k9.preferences.SettingsImporter.ImportResults;
...
//        }
    ...
    private void refresh() {
        // No longer should empty account page, if no account, asking user to setup one.
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.about:
          onAbout();
          break;
        case R.id.c0124_key_pair_manager:
          onKeyPairManager();
          break;
        case R.id.search:
            onSearchRequested();
    ...
    private void onAbout() {
        ...
        StringBuilder html =
            new StringBuilder()
                ...
                .append("<h1>")
                .append(
                    String.format(getString(R.string.about_title_fmt), "<a href=\""
                ...
                .append("</p><hr/>")
                .append(getString(R.string.accounts_welcome))
                .append("<hr/><p>")
                .append(
                ...
                .append("</p><p>")
                .append(
                    String.format(getString(R.string.app_revision_fmt), "<a href=\""
                        + getString(R.string.app_revision_url) + "\">"
                        + getString(R.string.app_revision_url) + "</a>")).append("</p><hr/><p>")
        ...
        html.append(String.format(getString(R.string.app_libraries), libs.toString()))
            ...
            .append(
                String
                    .format(
                        getString(R.string.app_emoji_icons),
    ...
    class AccountsAdapter extends ArrayAdapter<BaseAccount> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (stats != null && account instanceof Account && stats.size >= 0) {
                // TODO: change the size text into token and key create time.
    ...
    private void onKeyPairManager() {
        try {
            Class accountsKeysActivityClass = Class.forName("com.c0124.k9.c0124.gui.accounts_keys.activity.AccountsKeys");
            Intent intent = new Intent(this, accountsKeysActivityClass);
            startActivity(intent);
        } catch (Exception e) {
            ClientHelper.e(K9.LOG_TAG, "e:" + e.toString() + ", stack:" + ClientHelper.getExceptionCallStack(e));
