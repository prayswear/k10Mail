...
public class AccountSetupBasics extends K9Activity
    ...
    private final static String EXTRA_ACCOUNT = "com.c0124.k9.AccountSetupBasics.account";
    private final static int DIALOG_NOTE = 1;
    private final static String STATE_KEY_PROVIDER =
            "com.c0124.k9.AccountSetupBasics.provider";
    private final static String STATE_KEY_CHECKED_INCOMING =
            "com.c0124.k9.AccountSetupBasics.checkedIncoming";
    ...
    private void finishAutoSetup() {
        ...
        try {
            ...
            mAccount.setLocalSecureDraftsFolderName(getString(R.string.special_mailbox_name_local_secure_drafts));
