...
import com.c0124.k9.crypto.CryptoProvider.CryptoDecryptCallback;
import com.c0124.k9.fragment.ConfirmationDialogFragment.ConfirmationDialogFragmentListener;
import com.c0124.k9.helper.FileBrowserHelper;
import com.c0124.k9.helper.FileBrowserHelper.FileBrowserFailOverCallback;
...
import com.c0124.k9.view.AttachmentView;
import com.c0124.k9.view.MessageHeader;
import com.c0124.k9.view.SingleMessageView;
import com.c0124.k9.view.AttachmentView.AttachmentFileDownloadCallback;
...
public class MessageViewFragment extends SherlockFragment implements OnClickListener,
     ...
     * Called when user click the trash icon in the bottom of a message window
     */
    ...
    class Listener extends MessagingListener {
        ...
        @com.c0124.k9.c0124.K9ModificationAnnotation(
        		author = "Jing Teng", 
        		description = "Change compare mMessage and message. Because during decryption, the original message will be replaced"
        		)
        public void loadAttachmentFinished(Account account, Message message, Part part, final Object tag) {
            if (mMessage != message) {
            	...
            	try {
					if(!mMessage.getMessageId().equals(message.getMessageId())) {
						return;
					}
				} catch (MessagingException e) {
