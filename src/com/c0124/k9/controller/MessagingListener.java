...
public class MessagingListener {
    ...
    public void encryptPendingMessagesStarted(Account account) {}

    public void encryptPendingMessagesCompleted(Account account) {}

    public void encryptPendingMessagesFailed(Account account) {}
