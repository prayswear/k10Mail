...
public class Address extends TestCase {
    ...
    public void testParseWithMissingEmail() {
        com.c0124.k9.mail.Address[] addresses =  com.c0124.k9.mail.Address.parse("NAME ONLY");
    ...
    public void testPraseWithValidEmail() {
        com.c0124.k9.mail.Address[] addresses =  com.c0124.k9.mail.Address.parse("Max Mustermann <maxmuster@mann.com>");
        assertEquals(1, addresses.length);
    ...
    public void testPraseWithValidEmailMulti() {
        com.c0124.k9.mail.Address[] addresses =  com.c0124.k9.mail.Address.parse("lorem@ipsum.us,mark@twain.com");
